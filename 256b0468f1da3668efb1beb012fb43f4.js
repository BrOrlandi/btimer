...
var timerInput = exports.timerInput = document.getElementById('timerInput');
var timerEdit = exports.timerEdit = document.getElementById('timerEdit');
var timerDisplay = exports.timerDisplay = document.getElementById('timerDisplay');
var play = exports.play = document.getElementById('play');
var pause = exports.pause = document.getElementById('pause');
var restart = exports.restart = document.getElementById('restart');
...
(0, _vanillaMasker2.default)(_definitions.timerInput).maskPattern('99:99');

function dynamicMask(e) {
  var masks = ['99:99', '9:99'];
  var input = e.target;
  var value = input.value.replace(/\D/g, '');
  var maskIndex = value.trim().length === 3 ? 1 : 0;
  (0, _vanillaMasker2.default)(input).unMask();
  (0, _vanillaMasker2.default)(input).maskPattern(masks[maskIndex]);

  input.value = _vanillaMasker2.default.toPattern(value, masks[maskIndex]);
}

_definitions.timerInput.addEventListener('input', dynamicMask, false);
},{"vanilla-masker":14,"./definitions":8}],12:[function(require,module,exports) {
"use strict";
...
},{"./has-own-prop":61}],25:[function(require,module,exports) {
'use strict';
...
},{"./from-anything":59}],56:[function(require,module,exports) {
"use strict";
...
},{"../utils/extend":57,"./utc":25,"../create/parsing-flags":56,"../utils/some":58}],26:[function(require,module,exports) {
'use strict';
...
},{"../utils/hooks":16,"../utils/has-own-prop":61,"../utils/is-undefined":60,"../create/parsing-flags":56}],117:[function(require,module,exports) {
"use strict";
...
},{"./abs-floor":117}],82:[function(require,module,exports) {
'use strict';
...
},{"./to-int":81}],39:[function(require,module,exports) {
'use strict';
...
},{"./extend":57,"./hooks":16,"./is-undefined":60}],31:[function(require,module,exports) {
'use strict';
...
},{"../utils/is-function":31,"../utils/extend":57,"../utils/is-object":108,"../utils/has-own-prop":61}],93:[function(require,module,exports) {
"use strict";
...
},{"./has-own-prop":61}],94:[function(require,module,exports) {
'use strict';
...
},{"../utils/is-function":31}],95:[function(require,module,exports) {
'use strict';
...
},{"../utils/is-function":31}],55:[function(require,module,exports) {
'use strict';
...
},{"../utils/zero-fill":77,"../utils/is-function":31}],79:[function(require,module,exports) {
'use strict';
...
var matchWord = exports.matchWord = /[0-9]{0,256}['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]{1,256}|[\u0600-\u06FF\/]{1,256}(\s*?[\u0600-\u06FF]{1,256}){1,2}/i;
...
},{"../utils/has-own-prop":61,"../utils/is-function":31}],80:[function(require,module,exports) {
'use strict';
...
},{"../utils/has-own-prop":61,"../utils/is-number":90,"../utils/to-int":81}],92:[function(require,module,exports) {
"use strict";
...
},{"../moment/get-set":71,"../format/format":78,"./aliases":55,"./priorities":103,"../parse/regex":79,"../parse/token":80,"../utils/hooks":16,"./constants":92,"../utils/to-int":81}],71:[function(require,module,exports) {
'use strict';
...
},{"../units/aliases":55,"../units/priorities":103,"../utils/hooks":16,"../utils/is-function":31,"../units/month":45,"../units/year":54}],106:[function(require,module,exports) {
"use strict";
...
},{"../moment/get-set":71,"../utils/has-own-prop":61,"../format/format":78,"./aliases":55,"./priorities":103,"../parse/regex":79,"../parse/token":80,"../utils/hooks":16,"./constants":92,"../utils/to-int":81,"../utils/is-array":62,"../utils/is-number":90,"../utils/mod":106,"../utils/index-of":104,"../create/utc":25,"../create/parsing-flags":56,"../units/year":54}],105:[function(require,module,exports) {
"use strict";
...
},{"./year":54,"../create/local":24,"../create/date-from-array":105}],53:[function(require,module,exports) {
'use strict';
...
},{"../format/format":78,"./aliases":55,"./priorities":103,"../parse/regex":79,"../parse/token":80,"../utils/to-int":81,"../create/local":24,"./week-calendar-utils":107}],42:[function(require,module,exports) {
'use strict';
...
},{"../format/format":78,"./aliases":55,"./priorities":103,"../parse/regex":79,"../parse/token":80,"../utils/to-int":81,"../utils/is-array":62,"../utils/index-of":104,"../utils/has-own-prop":61,"../create/utc":25,"../create/parsing-flags":56}],47:[function(require,module,exports) {
'use strict';
...
},{"../moment/get-set":71,"../format/format":78,"./aliases":55,"./priorities":103,"../parse/regex":79,"../parse/token":80,"./constants":92,"../utils/to-int":81,"../utils/zero-fill":77,"../create/parsing-flags":56}],102:[function(require,module,exports) {
'use strict';
...
// week
},{"./calendar":94,"./formats":95,"./invalid":96,"./ordinal":97,"./relative":99,"../units/month":45,"../units/week":53,"../units/day-of-week":42,"../units/hour":47}],38:[function(require,module,exports) {
'use strict';
...
},{"../utils/is-array":62,"../utils/has-own-prop":61,"../utils/is-undefined":60,"../utils/compare-arrays":82,"../utils/deprecate":39,"./set":100,"./constructor":93,"../utils/keys":101,"./base-config":102}],111:[function(require,module,exports) {
'use strict';
...
},{"../units/month":45,"../units/constants":92,"../create/parsing-flags":56}],119:[function(require,module,exports) {
"use strict";
...
},{"../utils/hooks":16,"./date-from-array":105,"../units/year":54,"../units/week-calendar-utils":107,"../units/constants":92,"./local":24,"../utils/defaults":119,"./parsing-flags":56}],114:[function(require,module,exports) {
'use strict';
...
},{"./from-string-and-format":113,"./date-from-array":105,"./from-array":115,"../utils/hooks":16,"../utils/deprecate":39,"./parsing-flags":56,"../units/month":45,"../units/day-of-week":42}],113:[function(require,module,exports) {
'use strict';
...
},{"./from-string":114,"./from-array":115,"../parse/regex":79,"../parse/token":80,"../format/format":78,"./check-overflow":111,"../units/constants":92,"../utils/hooks":16,"./parsing-flags":56}],112:[function(require,module,exports) {
'use strict';
...
},{"../moment/constructor":26,"./from-string-and-format":113,"./parsing-flags":56,"./valid":23,"../utils/extend":57}],116:[function(require,module,exports) {
'use strict';
...
},{"../units/aliases":55,"./from-array":115,"../utils/map":110}],59:[function(require,module,exports) {
'use strict';
...
},{"../utils/is-array":62,"../utils/is-object":108,"../utils/is-object-empty":109,"../utils/is-undefined":60,"../utils/is-number":90,"../utils/is-date":21,"../utils/map":110,"./valid":23,"../moment/constructor":26,"../locale/locales":38,"../utils/hooks":16,"./check-overflow":111,"./from-string-and-array":112,"./from-string-and-format":113,"./from-string":114,"./from-array":115,"./from-object":116}],24:[function(require,module,exports) {
'use strict';
...
},{"./from-anything":59}],27:[function(require,module,exports) {
'use strict';
...
},{"../utils/deprecate":39,"../utils/is-array":62,"../create/local":24,"../create/valid":23}],28:[function(require,module,exports) {
"use strict";
...
},{"../utils/to-int":81,"../utils/index-of":104,"./constructor":34,"./create":33}],34:[function(require,module,exports) {
'use strict';
...
},{"../units/aliases":55,"../locale/locales":38,"./valid.js":63}],91:[function(require,module,exports) {
"use strict";
...
},{"../utils/zero-fill":77,"../duration/create":33,"../moment/add-subtract":64,"../moment/constructor":26,"../format/format":78,"../parse/regex":79,"../parse/token":80,"../create/local":24,"../create/from-anything":59,"../create/utc":25,"../utils/is-date":21,"../utils/to-int":81,"../utils/is-undefined":60,"../utils/compare-arrays":82,"../utils/hooks":16}],33:[function(require,module,exports) {
'use strict';
...
},{"./constructor":34,"../utils/is-number":90,"../utils/to-int":81,"../utils/abs-round":91,"../utils/has-own-prop":61,"../units/constants":92,"../units/offset":30,"../create/local":24,"./valid":63}],64:[function(require,module,exports) {
'use strict';
...
},{"./get-set":71,"../units/month":45,"../duration/create":33,"../utils/deprecate":39,"../utils/hooks":16,"../utils/abs-round":91}],18:[function(require,module,exports) {
'use strict';
...
},{"../create/local":24,"../units/offset":30,"../utils/is-function":31,"../utils/hooks":16}],65:[function(require,module,exports) {
'use strict';
...
},{"./constructor":26}],66:[function(require,module,exports) {
'use strict';
...
},{"./constructor":26,"../units/aliases":55,"../create/local":24,"../utils/is-undefined":60}],67:[function(require,module,exports) {
'use strict';
...
},{"../utils/abs-floor":117,"../units/offset":30,"../units/aliases":55}],68:[function(require,module,exports) {
'use strict';
...
},{"../format/format":78,"../utils/hooks":16,"../utils/is-function":31}],69:[function(require,module,exports) {
'use strict';
...
},{"../duration/create":33,"../create/local":24,"../moment/constructor":26}],70:[function(require,module,exports) {
'use strict';
...
},{"../duration/create":33,"../create/local":24,"../moment/constructor":26}],72:[function(require,module,exports) {
'use strict';
...
},{"../locale/locales":38,"../utils/deprecate":39}],73:[function(require,module,exports) {
'use strict';
...
},{"../units/aliases":55}],74:[function(require,module,exports) {
"use strict";
...
},{"../create/valid":23,"../utils/extend":57,"../create/parsing-flags":56}],76:[function(require,module,exports) {
"use strict";
...
},{"../format/format":78,"./aliases":55,"./priorities":103,"../parse/regex":79,"../parse/token":80,"./week-calendar-utils":107,"../utils/to-int":81,"../utils/hooks":16,"../create/local":24,"../create/date-from-array":105}],49:[function(require,module,exports) {
'use strict';
...
},{"../format/format":78,"./aliases":55,"./priorities":103,"../parse/regex":79,"../parse/token":80,"./constants":92,"../utils/to-int":81}],41:[function(require,module,exports) {
'use strict';
...
},{"../moment/get-set":71,"../format/format":78,"./aliases":55,"./priorities":103,"../parse/regex":79,"../parse/token":80,"./constants":92,"../utils/to-int":81}],44:[function(require,module,exports) {
'use strict';
...
},{"../format/format":78,"./aliases":55,"./priorities":103,"../parse/regex":79,"./year":54,"../create/date-from-array":105,"../parse/token":80,"../utils/to-int":81}],46:[function(require,module,exports) {
'use strict';
...
},{"../moment/get-set":71,"../format/format":78,"./aliases":55,"./priorities":103,"../parse/regex":79,"../parse/token":80,"./constants":92}],48:[function(require,module,exports) {
'use strict';
...
},{"../moment/get-set":71,"../format/format":78,"./aliases":55,"./priorities":103,"../parse/regex":79,"../parse/token":80,"./constants":92}],43:[function(require,module,exports) {
'use strict';
...
},{"../moment/get-set":71,"../format/format":78,"./aliases":55,"./priorities":103,"../parse/regex":79,"../parse/token":80,"./constants":92,"../utils/to-int":81}],50:[function(require,module,exports) {
'use strict';
...
},{"../format/format":78}],29:[function(require,module,exports) {
'use strict';
...
},{"./constructor":26,"./add-subtract":64,"./calendar":18,"./clone":65,"./compare":66,"./diff":67,"./format":68,"./from":69,"./to":70,"./get-set":71,"./locale":72,"./min-max":27,"./start-end-of":73,"./to-type":74,"./valid":75,"./creation-data":76,"../units/year":54,"../units/week-year":52,"../units/quarter":49,"../units/month":45,"../units/week":53,"../units/day-of-month":41,"../units/day-of-week":42,"../units/day-of-year":44,"../units/hour":47,"../units/minute":46,"../units/second":48,"../units/millisecond":43,"../units/offset":30,"../units/timezone":50,"../utils/deprecate":39}],17:[function(require,module,exports) {
'use strict';
...
},{"../create/local":24,"../create/utc":25,"../create/valid":23,"./constructor":26,"./min-max":27,"./now":28,"./prototype":29}],98:[function(require,module,exports) {
"use strict";
...
},{"./constructor":93,"./calendar":94,"./formats":95,"./invalid":96,"./ordinal":97,"./pre-post-format":98,"./relative":99,"./set":100,"../units/month":45,"../units/week":53,"../units/day-of-week":42,"../units/hour":47}],36:[function(require,module,exports) {
'use strict';
...
},{"../utils/is-number":90,"./locales":38,"../create/utc":25}],40:[function(require,module,exports) {
'use strict';
...
},{"./prototype":37,"./locales":38,"../utils/to-int":81}],19:[function(require,module,exports) {
'use strict';
...
},{"./prototype":37,"./locales":38,"./lists":36,"../utils/deprecate":39,"../utils/hooks":16,"./en":40}],83:[function(require,module,exports) {
"use strict";
...
},{"./create":33}],118:[function(require,module,exports) {
"use strict";
...
},{"../utils/abs-floor":117,"../utils/abs-ceil":118,"../create/date-from-array":105}],85:[function(require,module,exports) {
'use strict';
...
},{"./bubble":86,"../units/aliases":55,"../utils/to-int":81}],87:[function(require,module,exports) {
'use strict';
...
},{"./create":33}],88:[function(require,module,exports) {
'use strict';
...
},{"../units/aliases":55,"../utils/abs-floor":117}],35:[function(require,module,exports) {
'use strict';
...
},{"./create":33}],89:[function(require,module,exports) {
'use strict';
...
},{"../utils/abs-floor":117}],32:[function(require,module,exports) {
'use strict';
...
proto.lang = _locale.lang;
},{"./constructor":34,"./abs":83,"./add-subtract":84,"./as":85,"./bubble":86,"./clone":87,"./get":88,"./humanize":35,"./iso-string":89,"../moment/locale":72,"./valid":63,"../utils/deprecate":39}],20:[function(require,module,exports) {
'use strict';
...
},{"./prototype":32,"./create":33,"./constructor":34,"./humanize":35}],51:[function(require,module,exports) {
'use strict';
...
},{"../format/format":78,"../parse/regex":79,"../parse/token":80,"../utils/to-int":81}],22:[function(require,module,exports) {
'use strict';
...
},{"./day-of-month":41,"./day-of-week":42,"./day-of-year":44,"./hour":47,"./millisecond":43,"./minute":46,"./month":45,"./offset":30,"./quarter":49,"./second":48,"./timestamp":51,"./timezone":50,"./week-year":52,"./week":53,"./year":54,"./aliases":55}],15:[function(require,module,exports) {
'use strict';
...
_hooks.hooks.version = '2.19.3'; //! moment.js
//! version : 2.19.3
...
},{"./lib/utils/hooks":16,"./lib/moment/moment":17,"./lib/moment/calendar":18,"./lib/locale/locale":19,"./lib/duration/duration":20,"./lib/units/units":22,"./lib/utils/is-date":21}],13:[function(require,module,exports) {
'use strict';
...
function splitTime(time) {
  var momentTime = _moment2.default.duration(time, 'milliseconds');
  var sec = momentTime.seconds() < 10 ? '0' + momentTime.seconds() : momentTime.seconds();
  var min = momentTime.minutes() < 10 ? '0' + momentTime.minutes() : momentTime.minutes();
  var mil = Math.floor(momentTime.milliseconds());
  ...
  var minDigist = ('' + min).split('');
  var secDigist = ('' + sec).split('');
  var milDigist = ('' + mil).split('');
  return minDigist.concat(secDigist).concat(milDigist);
}

module.exports = function renderDisplay(display, time) {
  var digits = splitTime(time);

  var digitsDisplay = display.querySelectorAll('.digit');
...
module.exports="/distweb/4c2333a12ac79b636184ee2a987dc5a1.ogg";
},{}],5:[function(require,module,exports) {
'use strict';

var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

var _TimerFunction = require('./TimerFunction');

var _TimerFunction2 = _interopRequireDefault(_TimerFunction);

var _renderDisplay = require('./renderDisplay');

var _renderDisplay2 = _interopRequireDefault(_renderDisplay);

var _Aquila = require('../assets/Aquila.ogg');

var _Aquila2 = _interopRequireDefault(_Aquila);
...
var audio = new Audio(_Aquila2.default);

var Timer = function () {
  function Timer() {
    _classCallCheck(this, Timer);

    this.display = _definitions.timerDisplay;
    this.timer = new _TimerFunction2.default();
  ...
  _createClass(Timer, [{
    ...
    value: function setValue(value) {
      ...
      this.timer.duration(this.countdown);
      (0, _renderDisplay2.default)(this.display, this.countdown);
    }
  }, {
    key: 'start',
    value: function start(endCallback) {
      var _this = this;

      this._running = true;
      this._ennCallback = endCallback;
      this.timer.callback(function (time) {
        (0, _renderDisplay2.default)(_this.display, time);
        if (time <= 10000) {
          _this.display.classList.add('hurry');
        }
        if (time === 0) {
          _this._end();
        }
...
},{"./TimerFunction":12,"./renderDisplay":13,"../assets/Aquila.ogg":11,"./definitions":8}],7:[function(require,module,exports) {
'use strict';
...
var Elements = function () {
  ...
  _createClass(Elements, null, [{
    ...
    value: function showPlayButton() {
      _definitions.play.classList.remove('hide');
      _definitions.pause.classList.add('hide');
    }
  }, {
    key: 'showPauseButton',
    value: function showPauseButton() {
      _definitions.play.classList.add('hide');
      _definitions.pause.classList.remove('hide');
    }
  }, {
    key: 'showTimerDisplay',
    value: function showTimerDisplay() {
      _definitions.timerDisplay.classList.remove('hide');
      _definitions.timerEdit.classList.add('hide');
    }
  }, {
    key: 'showTimerInput',
    value: function showTimerInput() {
      _definitions.timerDisplay.classList.add('hide');
      _definitions.timerEdit.classList.remove('hide');
      _definitions.timerInput.focus();
    }
  }]);
...
},{"./definitions":8}],9:[function(require,module,exports) {
"use strict";
...
function parseInput(text) {
  ...
  var minutes = match[2] ? parseInt(match[1]) : 0;
  var seconds = match[2] ? parseInt(match[2]) : parseInt(match[1]);
...
var _parseInput = require('./parseInput');
...
function playTimer() {
  _elements2.default.showTimerDisplay();
  _elements2.default.showPauseButton();

  _timer2.default.start(function () {
    _elements2.default.showPlayButton();
  });
}
...
function playNewValue() {
  var inputText = _definitions.timerInput.value || '0';

  var value = (0, _parseInput2.default)(inputText);
  pauseTimer();
  _timer2.default.reset();
  _timer2.default.setValue(value);
  if (value) {
    playTimer();
  }
}

_definitions.play.addEventListener('click', function () {
  if (_definitions.timerEdit.classList.contains('hide')) {
    playTimer();
    return;
  }
  playNewValue();
...
_definitions.pause.addEventListener('click', function () {
  pauseTimer();
});

_definitions.restart.addEventListener('click', function () {
  restartTimer();
});
...
document.addEventListener('keyup', function (event) {
  ...
  if (event.target === _definitions.timerInput) {
    return;
  }
...
_definitions.timerDisplay.addEventListener('click', function () {
  _elements2.default.showTimerInput();
  pauseTimer();
});

_definitions.timerInput.addEventListener('keyup', function (event) {
  var code = event.code;

  var isExitCode = code === 'Escape' || code === 'Space' || code === 'Enter';
  if (isExitCode) {
    _elements2.default.showTimerDisplay();
...
},{"./inputMask":6,"./timer":5,"./elements":7,"./parseInput":9,"./definitions":8}],120:[function(require,module,exports) {
...
if (!module.bundle.parent && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket('ws://' + hostname + ':' + '33563' + '/');
...
//# sourceMappingURL=/distweb/256b0468f1da3668efb1beb012fb43f4.map